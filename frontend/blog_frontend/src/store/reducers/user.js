...
// Updated
const userProjectEditInit = (state, action) => {
    return updateObject(state, {
        loading: true,
        userProfile: null,
        error: null
...
const userProjectEditSuccess = (state, action) => {
    return updateObject(state, {
        loading: false,
        userProfile: null,
        error: null
...
const userProjectEditFail = (state, action) => {
    return updateObject(state, {
        loading: false,
        userProfile: null,
        error: action.error
...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case actionTypes.USER_PROJECT_EDIT_INIT:
            return userProjectEditInit(state, action);
        case actionTypes.USER_PROJECT_EDIT_SUCCESS:
            return userProjectEditSuccess(state, action);
        case actionTypes.USER_PROJECT_EDIT_FAIL:
            return userProjectEditFail(state, action);
        default:
            return state;
    }
};
