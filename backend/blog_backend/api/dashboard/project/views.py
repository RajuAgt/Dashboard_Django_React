...
def project_create_view(request):
    """View To Create New Project For The Logged In Users"""
...
class ProjectListView (generics.ListAPIView):
    """List View For Listing All The Project Of A Particular User"""
...
def project_delete_view(request):
    """View To Delete A Project For Logged In Users"""
    ...
    if request.method == 'DELETE':
        ...
        instance = Project.objects.get(slug=request.data.get('slug'))
        admin_user = User.objects.get(pk=1)  # PK Of Admin User Is 1
